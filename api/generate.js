...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const finalPrompt = `A full-body, high-quality studio photo of a happy Pembroke Welsh Corgi sitting and facing forward, wearing a hoodie. The hoodie features a seamless all-over repeating pattern: ${pattern}. The pattern is dense and evenly distributed across the hoodie, including the hood, sleeves, and torso, leaving no empty areas. The word \"${text}\" is printed in bold, bright lime-green capital letters across the chest. The hoodie looks soft and realistic, with natural fabric folds and texture. Use soft, even lighting and a neutral light gray studio background. Do not include any elements in the background. Do not show standalone hoodie mockups.`;
