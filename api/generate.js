...
module.exports = async (req, res) => {
  ...
  if (apparel === "pajama") {
    apparelDescription = "a full-body dog pajama suit without center line no zipper, button";
